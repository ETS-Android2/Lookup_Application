...
class SelectActivity4() : AppCompatActivity(), ActionMode.Callback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.itemselect_selectactivity4)


        itemSelection = getSharedPreferences("Situation4", MODE_PRIVATE)
                    ...
                    override fun onSelectionChanged() {
                        ...
                        tracker?.let {
                            ...
                            if (actionMode == null) actionMode =
                                    startSupportActionMode(this@SelectActivity4)
                            actionMode?.title =
