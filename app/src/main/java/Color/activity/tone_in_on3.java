...
public class tone_in_on3 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tone_in_on3);
        ...
        back2select.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(Color.activity.tone_in_on3.this, Color.activity.TopSelect.class);
                startActivity(i);
